...
$lang['Invoices.!error.invoice_id.exists'] = 'ID de nota de cobro no válido.';
$lang['Invoices.!error.invoice_recur_id.exists'] = 'ID de nota de cobro periódica no válido.';
$lang['Invoices.!error.method.exists'] = 'Debe establecer al menos un método de entrega.';
$lang['Invoices.!error.delivery.empty'] = 'Introduzca un método de entrega de la nota de cobro.';
$lang['Invoices.!error.delivery.length'] = 'La longitud del método de entrega de la nota de cobro no puede superar los 32 caracteres.';
$lang['Invoices.!error.invoice_add.failed'] = 'No se ha podido crear esta nota de cobro. Por favor, inténtelo de nuevo.';
$lang['Invoices.!error.id_format.empty'] = 'No se ha establecido ningún formato de identificación para las notas de cobro.';
$lang['Invoices.!error.id_format.length'] = 'El formato de identificación de las notas de cobro no puede superar los 64 caracteres.';
$lang['Invoices.!error.id_value.valid'] = 'No se ha podido determinar el valor del ID de la nota de cobro.';
$lang['Invoices.!error.id.amount_applied'] = 'Es posible que las líneas de nota de cobro, la moneda y el estado no se actualicen porque ya se ha aplicado un importe a esta nota de cobro.';
$lang['Invoices.!error.client_id.exists'] = 'ID de cliente no válido.';
$lang['Invoices.!error.date_billed.format'] = 'La fecha de cobro tiene un formato de fecha no válido.';
$lang['Invoices.!error.date_due.format'] = 'La fecha de vencimiento tiene un formato no válido.';
$lang['Invoices.!error.date_due.after_billed'] = 'La fecha de vencimiento debe ser igual o posterior a la fecha de notas de cobro.';
...
$lang['Invoices.!error.autodebit.valid'] = 'Seleccione si desea permitir o no el cargo automático para esta nota de cobro.';
...
$lang['Invoices.!error.date_renews.format'] = 'La fecha de renovación de la nota de cobro periódica debe tener un formato de fecha válido.';
$lang['Invoices.!error.date_last_renewed.format'] = 'La fecha de renovación de la última nota de cobro periódica debe tener un formato de fecha válido.';
$lang['Invoices.!error.invoice_id.draft'] = 'La nota de cobro en cuestión no es un borrador de nota de cobro, por lo que no se ha podido eliminar.';
...
$lang['Invoices.!error.line_items.empty_split'] = 'No se ha seleccionado ninguna línea de nota de cobro para dividir.';
$lang['Invoices.!error.line_items.minimum_split'] = 'La nota de cobro debe tener al menos 2 líneas para ser dividida.';
$lang['Invoices.!error.invoice_id.unique'] = 'La nota de cobro de destino no puede formar parte de las notas de cobro a fusionar.';
$lang['Invoices.!error.invoice_id.status'] = 'La nota de cobro de destino debe estar abierta y sin transacciones.';
$lang['Invoices.!error.invoice_ids.client'] = 'Todas las notas de cobro deben pertenecer al mismo cliente.';
$lang['Invoices.!error.invoice_ids.status'] = 'Todas las notas de cobro deben estar abiertas y sin transacciones.';
$lang['Invoices.!error.invoice_ids.currency'] = 'Todas las notas de cobro deben tener la misma moneda.';
$lang['Invoices.!error.invoice_ids.count'] = 'Deben seleccionarse al menos dos notas de cobro.';
