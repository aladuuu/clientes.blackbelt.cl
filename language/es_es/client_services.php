...
$lang['ClientServices.!error.invoices_manage_options'] = 'Las opciones configurables no pueden modificarse hasta que se hayan pagado todas las notas de cobro que contengan este servicio.';
$lang['ClientServices.!error.invoices_change_term'] = 'El plazo no podrá modificarse hasta que se hayan abonado todas las notas de cobro que contengan este servicio.';
$lang['ClientServices.!error.invoices_renew_service'] = 'El servicio no podrá renovarse hasta que se hayan abonado todas las notas de cobro que lo contengan.';
$lang['ClientServices.!error.invoices_upgrade_package'] = 'El paquete no podrá modificarse hasta que se hayan abonado todas las notas de cobro que contengan este servicio.';
$lang['ClientServices.!error.tab_unavailable'] = 'No se puede acceder a esa sección mientras el servicio esté en estado %1$s.';
$lang['ClientServices.!warning.invoices_upgrade_package'] = 'Los paquetes no podrán modificarse hasta que se hayan abonado todas las notas de cobro correspondientes a este servicio.';
$lang['ClientServices.!warning.invoices_change_term'] = 'El plazo no podrá modificarse hasta que se hayan abonado todas las notas de cobro correspondientes a este servicio.';
$lang['ClientServices.!warning.invoices_manage_options'] = 'Las opciones configurables no pueden modificarse hasta que se hayan abonado todas las notas de cobro correspondientes a este servicio.';
...
$lang['ClientServices.index.no_results'] = 'No tiene servicios activos.';
...
$lang['ClientServices.manage.heading_package_term'] = 'Ciclo de notas de cobro';
...
$lang['ClientServices.manage.heading_date_next_invoice'] = 'Siguiente nota de cobro';
...
$lang['ClientServices.renew.confirm_renew'] = 'Al hacer clic en "Guardar" se generará una nueva nota de cobro para la renovación del servicio por el plazo "%1$s", que cubrirá el servicio hasta "%2$s", al hacer clic en "Guardar" será redirigido a la página de pago para abonar la nota de cobro generada.';
...
$lang['ClientServices.upgrade.text_prorate'] = 'Si el nuevo paquete que elija cuesta más, se le cobrará la diferencia prorrateada.';
