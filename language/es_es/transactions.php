...
$lang['Transactions.!error.transaction_id.currency_matches'] = 'Los importes de la nota de cobro no se han podido aplicar porque no coinciden con la moneda de la transacción.';
$lang['Transactions.!error.invoice_id.exists'] = 'ID de nota de cobro no válido.';
$lang['Transactions.!error.amounts.overage'] = 'No se han podido aplicar uno o varios valores de Importe a pagar a la nota de cobro especificada. Asegúrate de que el Importe a pagar no supere el Importe a pagar de la nota de cobro, que la nota de cobro esté abierta y que la suma de los valores de Importe a pagar no supere el Importe de pago o de crédito.';
...
$lang['Transactions.!error.currency.mismatch'] = 'La moneda indicada no coincide con al menos una de las notas de cobro asociadas.';
