...
$lang['CronTasks.crontask.name.create_invoice'] = 'Crear nota de cobro';
$lang['CronTasks.crontask.description.create_invoice'] = 'Las notas de cobro periódicas y la renovación de servicios se cobrarán a través de esta tarea, que se ejecuta una vez al día a la hora especificada.';
$lang['CronTasks.crontask.name.apply_invoice_late_fees'] = 'Aplicar recargos por demora en la notas de cobro';
$lang['CronTasks.crontask.description.apply_invoice_late_fees'] = 'Aplica recargos por demora a las notas de cobro abiertas un número configurado de días después de su vencimiento.';
$lang['CronTasks.crontask.name.autodebit'] = 'Débito automático';
$lang['CronTasks.crontask.description.autodebit'] = 'Las cuentas de pago seleccionadas para débito automático se ejecutarán para pagar las notas de cobro pendientes diariamente a la hora especificada.';
...
$lang['CronTasks.crontask.name.apply_payments'] = 'Aplicar pagos a notas de cobro pendientes';
$lang['CronTasks.crontask.description.apply_payments'] = 'Los abonos sueltos se aplican automáticamente a las notas de cobro pendientes en el intervalo seleccionado.';
...
$lang['CronTasks.crontask.name.deliver_invoices'] = 'Entregar notas de cobro';
$lang['CronTasks.crontask.description.deliver_invoices'] = 'Las notas de cobro cuya entrega esté programada se enviarán en el intervalo seleccionado.';
...
$lang['CronTasks.crontask.description.deliver_reports'] = 'Los informes de deudores, generación de notas de cobro, obligaciones fiscales y otros se entregarán diariamente a la hora especificada.';
...
$lang['CronTasks.crontask.name.transition_quotations'] = 'Cotizaciones de transición';
