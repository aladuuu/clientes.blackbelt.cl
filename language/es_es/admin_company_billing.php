...
$lang['AdminCompanyBilling.!success.invoices_updated'] = 'Los ajustes de Notas de cobro y Cargo se han actualizado correctamente.';
...
$lang['AdminCompanyBilling.!success.deliverymethods_updated'] = 'La configuración de la entrega de notas de cobro se ha actualizado correctamente.';
...
$lang['AdminCompanyBilling.!success.customization_updated'] = 'Los ajustes de personalización de la nota de cobro se han actualizado correctamente.';
$lang['AdminCompanyBilling.!error.inv_start.valid'] = 'El valor inicial de la nota de cobro debe ser un número.';
$lang['AdminCompanyBilling.!error.inv_increment.valid'] = 'El valor de incremento de la nota de cobro debe ser un número.';
...
$lang['AdminCompanyBilling.!error.extension_zlib'] = 'La extensión Zlib es necesaria para la compresión de notas de cobro.';
...
$lang['AdminCompanyBilling.!tooltip.inv_days_before_renewal'] = 'El número de días antes de que se renueve un servicio o una nota de cobro periódica para generar una nota de cobro.';
...
$lang['AdminCompanyBilling.!tooltip.autodebit_days_before_due'] = 'El número de días antes del vencimiento de una nota de cobro para el cargo automático en la cuenta de pago predeterminada del cliente (si el cliente está configurado para el cargo automático).';
$lang['AdminCompanyBilling.!tooltip.suspend_services_days_after_due'] = 'El número de días que hay que esperar tras el vencimiento de una nota de cobro por un servicio antes de suspender el servicio.';
...
$lang['AdminCompanyBilling.!tooltip.cancel_service_changes_days'] = 'Los cambios de servicio en cola se cancelarán automáticamente cuando su nota de cobro permanezca impagada durante el número de días seleccionado.';
$lang['AdminCompanyBilling.!tooltip.apply_inv_late_fees'] = 'Aplique un recargo por demora a las notas de cobro abiertas un número determinado de días después de su vencimiento.';
$lang['AdminCompanyBilling.!tooltip.autodebit'] = 'Permite el adeudo automático de un cliente cuando vence el pago.';
$lang['AdminCompanyBilling.!tooltip.client_set_invoice'] = 'Marque esta opción para permitir que el cliente elija el método de entrega de notas de cobro que prefiera (por ejemplo, papel o correo electrónico).';
$lang['AdminCompanyBilling.!tooltip.inv_suspended_services'] = 'Marque esta casilla para seguir cobrando los servicios suspendidos.';
$lang['AdminCompanyBilling.!tooltip.inv_group_services'] = 'Crea una única nota de cobro para los servicios que se renuevan el mismo día para un cliente. Si se desmarca, se creará una nota de cobro independiente para cada servicio.';
...
$lang['AdminCompanyBilling.!tooltip.inv_lines_verbose_option_dates'] = 'Marque esta casilla para incluir el intervalo de fechas de servicio para cada partida de nota de cobro de opción configurable.';
...
$lang['AdminCompanyBilling.!tooltip.auto_apply_credits'] = 'Marque esta opción para permitir que Blesta aplique créditos automáticamente a las notas de cobro abiertas (primero las más antiguas).';
$lang['AdminCompanyBilling.!tooltip.auto_paid_pending_services'] = 'Marque esta opción para permitir que Blesta aprovisione automáticamente los servicios que estén pendientes y que tengan una nota de cobro pagada.';
$lang['AdminCompanyBilling.!tooltip.void_invoice_canceled_service'] = 'Si se selecciona esta opción, las cancelaciones de servicios también anularán cualquier nota de cobro abierta asociada al servicio cancelado. Si dicha nota de cobro contiene partidas no asociadas al servicio, las partidas del servicio se eliminarán en su lugar y la nota de cobro no se anulará.';
$lang['AdminCompanyBilling.!tooltip.void_inv_canceled_service_days'] = 'Si la nota de cobro asociada a un servicio anulado está vencida, sólo se anulará si no está vencida más del número de días seleccionado.';
...
$lang['AdminCompanyBilling.!tooltip.late_fee_total_amount'] = 'Si el tipo de comisión es porcentual, active esta casilla para calcular la comisión en función del importe total de la nota de cobro. Si no está marcada, la comisión se calculará únicamente sobre el importe impagado.';
...
$lang['AdminCompanyBilling.!tooltip.first_notice'] = 'El número de días antes o después del vencimiento de una nota de cobro para enviar el primer correo electrónico de aviso de retraso.';
$lang['AdminCompanyBilling.!tooltip.second_notice'] = 'El número de días antes o después del vencimiento de una nota de cobro para enviar el segundo correo electrónico de aviso de retraso.';
$lang['AdminCompanyBilling.!tooltip.third_notice'] = 'El número de días antes o después del vencimiento de una nota de cobro para enviar el tercer correo electrónico de aviso de retraso.';
...
$lang['AdminCompanyBilling.!tooltip.inv_type'] = 'Tipo de nota de cobro que se crea por defecto. Las notas de cobro pro forma cambian a notas de cobro estándar después de haber sido pagadas y cerradas.';
$lang['AdminCompanyBilling.!tooltip.inv_format'] = 'Las etiquetas disponibles son: {num} - el número de nota de cobro (obligatorio); {year} - el año de cuatro dígitos; {month} - el mes de dos dígitos; {day} - el día del mes de dos dígitos.';
$lang['AdminCompanyBilling.!tooltip.inv_draft_format'] = 'Las etiquetas disponibles son: {num} - el número de nota de cobro (obligatorio); {year} - el año de cuatro dígitos; {month} - el mes de dos dígitos; {day} - el día del mes de dos dígitos.';
$lang['AdminCompanyBilling.!tooltip.inv_proforma_format'] = 'Las etiquetas disponibles son: {num} - el número de nota de cobro (obligatorio); {year} - el año de cuatro dígitos; {month} - el mes de dos dígitos; {day} - el día del mes de dos dígitos.';
$lang['AdminCompanyBilling.!tooltip.inv_start'] = 'Los números de nota de cobro comenzarán (y se incrementarán) a partir de este valor inicial.';
$lang['AdminCompanyBilling.!tooltip.inv_proforma_start'] = 'Los números de nota de cobro comenzarán (y se incrementarán) a partir de este valor inicial.';
$lang['AdminCompanyBilling.!tooltip.inv_increment'] = 'Los números de nota de cobro posteriores se incrementarán en este valor.';
$lang['AdminCompanyBilling.!tooltip.inv_pad_size'] = 'El tamaño de relleno de la nota de cobro establece la longitud mínima de los caracteres de los números de nota de cobro.';
$lang['AdminCompanyBilling.!tooltip.inv_pad_str'] = 'Los números de nota de cobro cuya longitud de caracteres sea inferior al tamaño de relleno de la nota de cobro se rellenarán a la izquierda con el carácter indicado.';
$lang['AdminCompanyBilling.!tooltip.inv_cache'] = 'Guarda en disco una copia en caché de cada nota de cobro.';
...
$lang['AdminCompanyBilling.!tooltip.inv_logo'] = 'Cargue el logotipo que aparecerá en la nota de cobro.';
$lang['AdminCompanyBilling.!tooltip.inv_background'] = 'Cargue el fondo que aparecerá en la nota de cobro.';
$lang['AdminCompanyBilling.!tooltip.inv_paper_size'] = 'El tamaño del papel de la nota de cobro.';
$lang['AdminCompanyBilling.!tooltip.inv_template'] = 'La plantilla de nota de cobro que se utilizará para generar la nota de cobro.';
$lang['AdminCompanyBilling.!tooltip.inv_mimetype'] = 'El tipo de archivo de la nota de cobro. Las plantillas de nota de cobro pueden admitir varios tipos de archivo.';
...
$lang['AdminCompanyBilling.!tooltip.inv_terms'] = 'Introduzca las condiciones de pago o cualquier otra información que desee que aparezca en la nota de cobro.';
...
$lang['AdminCompanyBilling.invoices.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Opciones de notas de cobro y cargos';
$lang['AdminCompanyBilling.invoices.boxtitle_invoices'] = 'Opciones de notas de cobro y cobro';
$lang['AdminCompanyBilling.invoices.field.inv_days_before_renewal'] = 'Días de notas de cobro antes de la renovación';
...
$lang['AdminCompanyBilling.invoices.field.apply_inv_late_fees'] = 'Aplicar recargo por demora a las notas de cobro abiertas después de su vencimiento';
$lang['AdminCompanyBilling.invoices.field.autodebit'] = 'Activar débito automático';
$lang['AdminCompanyBilling.invoices.field.client_set_invoice'] = 'Permitir que el cliente establezca el método de notas de cobro';
$lang['AdminCompanyBilling.invoices.field.inv_suspended_services'] = 'Notas de cobro de servicios suspendidos';
$lang['AdminCompanyBilling.invoices.field.inv_group_services'] = 'Cobrarj untos los servicios';
$lang['AdminCompanyBilling.invoices.field.inv_append_descriptions'] = 'Incluir descripciones de los paquetes en las notas de cobro';
...
$lang['AdminCompanyBilling.invoices.field.void_invoice_canceled_service'] = 'Anular notas de cobro pendientes al cancelar un servicio';
$lang['AdminCompanyBilling.invoices.field.void_inv_canceled_service_days'] = 'Anular notas de cobro pendientes días después del vencimiento';
...
$lang['AdminCompanyBilling.notices.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Avisos';
...
$lang['AdminCompanyBilling.notices.text_inv_duedate'] = 'Fecha de vencimiento de la nota de cobro';
...
$lang['AdminCompanyBilling.coupons.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Cupones';
...
$lang['AdminCompanyBilling.addcoupon.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Nuevo cupón';
...
$lang['AdminCompanyBilling.editcoupon.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Editar cupón';
...
$lang['AdminCompanyBilling.customization.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Personalización de la nota de cobro';
$lang['AdminCompanyBilling.customization.boxtitle_customization'] = 'Personalización de notas de cobro';
...
$lang['AdminCompanyBilling.customization.field.inv_format'] = 'Formato de nota de cobro';
$lang['AdminCompanyBilling.customization.field.inv_draft_format'] = 'Formato de borrador de nota de cobro';
$lang['AdminCompanyBilling.customization.field.inv_proforma_format'] = 'Formato de nota de cobro pro forma';
$lang['AdminCompanyBilling.customization.field.inv_start'] = 'Valor inicial de la nota de cobro';
$lang['AdminCompanyBilling.customization.field.inv_proforma_start'] = 'Valor inicial de la nota de cobro pro forma';
$lang['AdminCompanyBilling.customization.field.inv_increment'] = 'Valor de incremento de la nota de cobro';
$lang['AdminCompanyBilling.customization.field.inv_pad_size'] = 'Tamaño del relleno de la nota de cobro';
$lang['AdminCompanyBilling.customization.field.inv_pad_str'] = 'Carácter de relleno de la nota de cobro';
$lang['AdminCompanyBilling.customization.field.inv_type'] = 'Tipo de nota de cobro';
...
$lang['AdminCompanyBilling.customization.field.inv_cache'] = 'Método de caché de notas de cobro';
$lang['AdminCompanyBilling.customization.field.inv_cache_compress'] = 'Comprimir notas de cobro PDF';
...
$lang['AdminCompanyBilling.customization.field.inv_template'] = 'Plantilla de nota de cobro';
$lang['AdminCompanyBilling.customization.field.inv_display'] = 'Visualización en nota de cobro';
...
$lang['AdminCompanyBilling.customization.field.inv_mimetype'] = 'Tipo de archivo de nota de cobro';
...
$lang['AdminCompanyBilling.acceptedtypes.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Tipos de pago aceptados';
...
$lang['AdminCompanyBilling.deliverymethods.page_title'] = 'Configuración > Empresa > Notas de cobro/Pago > Entrega de notas de cobro';
$lang['AdminCompanyBilling.deliverymethods.boxtitle_deliverymethods'] = 'Entrega de notas de cobro';
...
$lang['AdminCompanyBilling.deliverymethods.interfax_desc'] = 'InterFax le permite enviar notas de cobro por fax a través de Internet. <a href="http://www.interfax.net/" target="_blank">Regístrese</a> para obtener una cuenta de InterFax y empiece a enviar notas de cobro por fax hoy mismo.';
$lang['AdminCompanyBilling.deliverymethods.heading_postalmethods'] = 'Métodos postales';
$lang['AdminCompanyBilling.deliverymethods.postalmethods_desc'] = 'PostalMethods imprime, rellena y envía las notas de cobro a sus clientes por usted. <a href="https://cp.postalmethods.com/public/agentredirect.aspx?agentid=5bcfe2fb-b897-4a26-8c91-4089e92e2a7d" target="_blank">Regístrese</a> en PostalMethods y empiece a enviar notas de cobro hoy mismo.';
$lang['AdminCompanyBilling.deliverymethods.field_delivery_methods'] = 'Métodos de entrega de notas de cobro';
...
$lang['AdminCompanyBilling.deliverymethods.note_doublesided'] = 'Si esta opción está marcada, las notas de cobro enviadas a PostalMethods se imprimirán en el anverso y el reverso de la página.';
$lang['AdminCompanyBilling.deliverymethods.note_colored'] = 'Tenga en cuenta que si esta opción está marcada, todas las notas de cobro enviadas a PostalMethods serán en color en lugar de en blanco y negro.';
...
$lang['AdminCompanyBilling.latefees.field.late_fee_total_amount'] = 'Aplicar al importe total de la nota de cobro';
