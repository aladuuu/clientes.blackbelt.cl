...
$lang['Cron.applycredits.attempt'] = 'Intento de aplicar créditos a notas de cobro pendientes.';
...
$lang['Cron.applycredits.apply_success'] = 'Se han aplicado correctamente los créditos pendientes de la transacción %1$s para el cliente #%2$s a la nota de cobro #%3$s por un importe de %4$s.';
$lang['Cron.applycredits.apply_none'] = 'No hay notas de cobro a las que se puedan aplicar créditos.';
$lang['Cron.autodebitinvoices.attempt'] = 'Intento de cargo automático de notas de cobro pendientes.';
$lang['Cron.autodebitinvoices.completed'] = 'La tarea de domiciliación automática de notas de cobro ha finalizado.';
$lang['Cron.autodebitinvoices.charge_attempt'] = 'Intento de cargo automático al cliente #%1$s de todas las notas de cobro pendientes por importe de %2$s.';
