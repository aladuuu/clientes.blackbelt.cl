...
$lang['AdminClients.!success.invoice_added'] = 'La nota de cobro #%1$s se ha creado correctamente.';
$lang['AdminClients.!success.invoice_updated'] = 'La nota de cobro #%1$s se ha actualizado correctamente.';
$lang['AdminClients.!success.draftinvoice_added'] = 'Se ha creado correctamente el borrador de nota de cobro #%1$s.';
$lang['AdminClients.!success.draftinvoice_updated'] = 'El borrador de nota de cobro #%1$s se ha actualizado correctamente.';
$lang['AdminClients.!success.draftinvoice_created'] = 'El borrador de nota de cobro #%1$s se ha creado correctamente como nota de cobro #%2$s.';
$lang['AdminClients.!success.quotation_added'] = 'Se ha creado correctamente la cotizacion #%1$s.';
$lang['AdminClients.!success.quotation_updated'] = 'La cotizacion #%1$s se ha actualizado correctamente.';
...
$lang['AdminClients.!success.invoicequotation_invoiced'] = 'El presupuesto #%1$s se ha cobrado correctamente como nota de cobro #%2$s.';
...
$lang['AdminClients.!success.recurinvoice_deleted'] = 'La nota de cobro periódica se ha eliminado correctamente.';
$lang['AdminClients.!success.recurinvoice_updated'] = 'La nota de cobro periódica se ha actualizado correctamente.';
$lang['AdminClients.!success.edittransaction_updated'] = 'La transacción se ha actualizado correctamente.';
$lang['AdminClients.!success.transaction_unapplied'] = 'La transacción se ha anulado correctamente de la nota de cobro.';
$lang['AdminClients.!success.invoices_queued'] = 'Las notas de cobro seleccionadas se han puesto en cola para su entrega.';
$lang['AdminClients.!success.invoices_delivered'] = 'Las notas de cobro seleccionadas se han entregado correctamente.';
$lang['AdminClients.!success.invoices_voided'] = 'Las siguientes notas de cobro se han anulado correctamente: %1$s.';
$lang['AdminClients.!success.quotations_delivered'] = 'Los presupuestos seleccionados se entregaron con éxito.';
$lang['AdminClients.!success.quotations_status_updated'] = 'Se han actualizado correctamente las siguientes cotizaciones: %1$s.';
...
$lang['AdminClients.!success.deletedraftinvoice_deleted'] = 'El borrador de nota de cobro se ha eliminado correctamente.';
...
$lang['AdminClients.!error.invoice_credits.required'] = 'Seleccione una nota de cobro a la que se puedan aplicar créditos.';
...
$lang['AdminClients.!error.invoices_not_voided'] = 'No se han podido anular las siguientes notas de cobro porque contienen pagos parciales: %1$s.';
...
$lang['AdminClients.!error.invoices_renew_service'] = 'El servicio no podrá renovarse hasta que se hayan abonado todas las notas de cobro que lo contengan.';
$lang['AdminClients.!notice.invoice_tax_rules_differ'] = 'ADVERTENCIA: Esta nota de cobro contiene normas fiscales que ya no están en vigor. Si añade o elimina una partida o actualiza la cantidad, el coste unitario o el estado fiscal, se aplicarán las normas fiscales más recientes a esta nota de cobro.';
...
$lang['AdminClients.!notice.transactions_already_applied'] = 'ADVERTENCIA: La modificación del estado de esta transacción eliminará esta transacción de todas las notas de cobro aplicadas actualmente.';
$lang['AdminClients.!notice.service_in_review'] = 'El estado de este servicio es actualmente %1$s y debe cambiarse a %2$s antes de que pueda activarse. Esto puede hacerse a través del widget Pedidos de la página Resumen de notas de cobro mediante el plugin Pedidos, o mediante un plugin de terceros responsable de la gestión de pedidos.';
...
$lang['AdminClients.!notice.delete_client'] = 'Esto eliminará permanentemente el cliente y todos los registros asociados (por ejemplo, contactos, servicios, notas de cobro, transacciones, cuentas de pago, etc.). SE TRATA DE UNA ACCIÓN PERMANENTE E IRREVOCABLE.';
...
$lang['AdminClients.!notice.void_invoice_pending_services'] = 'Está intentando anular una o más notas de cobro que tienen servicios pendientes asociados. Si se anula la nota de cobro, no se deberá nada por el servicio pendiente y se activará.';
...
$lang['AdminClients.add.heading_billing'] = 'Información de notas de cobro';
...
$lang['AdminClients.add.field_state'] = 'Region';
...
$lang['AdminClients.add.field_taxid'] = 'Número de identificación RUT';
...
$lang['AdminClients.addcontact.field_state'] = 'Region';
...
$lang['AdminClients.createinvoice.page_title'] = 'Cliente #%1$s Crear nota de cobro';
$lang['AdminClients.createinvoice.boxtitle_createinvoice'] = 'Crear nota de cobro';
...
$lang['AdminClients.createinvoice.field_datebilled'] = 'Fecha de notas de cobro:';
$lang['AdminClients.createinvoice.field_datedue'] = 'Fecha de vencimiento:';
$lang['AdminClients.createinvoice.field_invoicedelivery'] = 'Entrega de notas de cobro:';
$lang['AdminClients.createinvoice.field_autodebit'] = 'Débito automático:';
$lang['AdminClients.createinvoice.field_autodebit_text'] = 'Permitir el cargo automático de esta nota de cobro';
$lang['AdminClients.createinvoice.tooltip_autodebit'] = 'Al marcar esta casilla, se habilitará el débito automático de esta nota de cobro si el débito automático está habilitado y disponible para el cliente.';
...
$lang['AdminClients.createinvoice.section_recurringinvoice'] = 'Nota de cobro recurrente';
...
$lang['AdminClients.editquotation.boxtitle_editquotation'] = 'Editar cotizacion [%1$s]';
...
$lang['AdminClients.invoicequotation.field_invoice_single'] = 'Nota de cobro única';
$lang['AdminClients.invoicequotation.field_invoice_two'] = 'Dos notas de cobro';
...
$lang['AdminClients.invoicequotation.field_submit'] = 'Crear nota de cobro';
...
$lang['AdminClients.edit.heading_billing'] = 'Información de notas de cobro';
...
$lang['AdminClients.edit.field_state'] = 'Region';
...
$lang['AdminClients.edit.field_taxid'] = 'Número de identificación RUT';
$lang['AdminClients.edit.field_preferredcurrency'] = 'Moneda preferente';
$lang['AdminClients.edit.field_invoiceaddress'] = 'Dirección de notas de cobro';
...
$lang['AdminClients.editcontact.field_state'] = 'Region';
...
$lang['AdminClients.editinvoice.page_title'] = 'Cliente #%1$s Editar nota de cobro #%2$s';
$lang['AdminClients.editinvoice.boxtitle_editinvoice'] = 'Editar nota de cobro [%1$s]';
$lang['AdminClients.editinvoice.boxtitle_editdraft'] = 'Editar borrador de nota de cobro [%1$s]';
...
$lang['AdminClients.editinvoice.field_datebilled'] = 'Fecha de notas de cobro:';
$lang['AdminClients.editinvoice.field_datedue'] = 'Fecha de vencimiento:';
$lang['AdminClients.editinvoice.field_invoicedelivery'] = 'Entrega de notas de cobro:';
$lang['AdminClients.editinvoice.field_autodebit'] = 'Débito automático:';
$lang['AdminClients.editinvoice.field_autodebit_text'] = 'Permitir el cargo automático de esta nota de cobro';
$lang['AdminClients.editinvoice.tooltip_autodebit'] = 'Al marcar esta casilla, se habilitará el débito automático de esta nota de cobro si el débito automático está habilitado y disponible para el cliente.';
$lang['AdminClients.editinvoice.field_recache'] = 'Recache:';
$lang['AdminClients.editinvoice.field_recache_text'] = 'Guardar esta nota de cobro en caché al actualizarla';
$lang['AdminClients.editinvoice.tooltip_recache'] = 'Al marcar esta casilla se sustituirá la nota de cobro almacenada en caché por los datos actualizados al guardarla.';
...
$lang['AdminClients.editinvoice.field_invoicesubmit'] = 'Modificar nota de cobro';
$lang['AdminClients.editinvoice.field_invoicedvoid'] = 'Nota de cobro nula';
...
$lang['AdminClients.editinvoice.field_invoicedelete'] = 'Borrar nota de cobro';
$lang['AdminClients.editinvoice.section_recurringinvoice'] = 'Nota de cobro recurrente';
...
$lang['AdminClients.editrecurinvoice.page_title'] = 'Cliente #%1$s Editar nota de cobro periódica #%2$s';
$lang['AdminClients.editrecurinvoice.boxtitle_editinvoice'] = 'Editar nota de cobro periódica [%1$s]';
$lang['AdminClients.editinvoice.confirm_deleterecur'] = 'Esto eliminará permanentemente esta nota de cobro periódica. No se generarán más notas de cobro utilizando esta nota de cobro periódica. ¿Está seguro de que desea eliminarla?';
...
$lang['AdminClients.edittransaction.subheading_invoice'] = 'Nota de cobro #';
...
$lang['AdminClients.edittransaction.applied_no_results'] = 'Esta transacción no se ha aplicado a ninguna nota de cobro.';
$lang['AdminClients.edittransaction.option_unapply'] = 'Desaplicar';
$lang['AdminClients.edittransaction.confirm_unapply'] = '¿Realmente anular esta transacción de la nota de cobro seleccionada?';
...
$lang['AdminClients.invoices.page_title'] = 'Cliente #%1$s Notas de cobro';
$lang['AdminClients.invoices.boxtitle_invoices'] = 'Notas de cobro';
$lang['AdminClients.invoices.heading_invoice'] = 'Nota de cobro #';
...
$lang['AdminClients.invoices.heading_datebilled'] = 'Fecha de notas de cobro';
...
$lang['AdminClients.invoices.categorylink_createinvoice'] = 'Crear nota de cobro';
...
$lang['AdminClients.invoices.confirm_delete'] = '¿Está seguro de que desea eliminar este borrador de nota de cobro?';
$lang['AdminClients.invoices.optionexpand_edit'] = 'Editar';
$lang['AdminClients.invoices.action_deliver'] = 'Entregar vía %1$s';
$lang['AdminClients.invoices.action_void'] = 'Notas de cobro nulas';
...
$lang['AdminClients.invoices.no_results'] = 'No hay notas de cobro con este estado.';
$lang['AdminClients.invoices.applied_no_results'] = 'Esta nota de cobro no tiene ninguna transacción aplicada.';
...
$lang['AdminClients.quotations.page_title'] = 'Cotizaciones de notas de cobro';
$lang['AdminClients.quotations.boxtitle_quotations'] = 'Cotizaciones';
$lang['AdminClients.quotations.heading_quotation'] = 'Cotizacion';
...
$lang['AdminClients.quotations.category_invoiced'] = 'Pagado';
...
$lang['AdminClients.quotations.option_invoice'] = 'Crear nota de cobro';
$lang['AdminClients.quotations.option_approve'] = 'Aprobar';
$lang['AdminClients.quotations.confirm_approve'] = '¿Está seguro de que desea aprobar esta cotizacion?';
...
$lang['AdminClients.quotationinvoices.headingexpand_invoice'] = 'Nota de cobro #';
...
$lang['AdminClients.quotationinvoices.headingexpand_date_billed'] = 'Fecha de notas de cobro';
$lang['AdminClients.quotationinvoices.headingexpand_options'] = 'Opciones';
$lang['AdminClients.quotationinvoices.option_view'] = 'Ver';
$lang['AdminClients.quotationinvoices.invoices_no_results'] = 'No hay notas de cobro asociadas a este presupuesto.';
...
$lang['AdminClients.addservice_basic.field_invoice_method'] = 'Método de notas de cobro';
$lang['AdminClients.addservice_basic.field_invoice_method_create'] = 'Crear nota de cobro';
$lang['AdminClients.addservice_basic.field_invoice_method_append'] = 'Añadir a la nota de cobro';
$lang['AdminClients.addservice_basic.field_invoice_method_dont'] = 'No cobrar';
...
$lang['AdminClients.addservice_confirm.field_invoice_method'] = 'Método de notas de cobro:';
$lang['AdminClients.addservice_confirm.field_invoice_method_create'] = 'Crear nota de cobro';
$lang['AdminClients.addservice_confirm.field_invoice_method_append'] = 'Añadir a nota de cobro %1$s';
$lang['AdminClients.addservice_confirm.field_invoice_method_none'] = 'No cobrar';
...
$lang['AdminClients.editservice.tooltip_prorate'] = 'Si se prorratea, se generará una nota de cobro para cubrir la diferencia de precio entre el precio actual y el nuevo. Sin embargo, el prorrateo no puede producirse si se establece un precio de anulación.';
$lang['AdminClients.editservice.tooltip_prorate_renewal'] = 'Se generará una nota de cobro para cubrir la diferencia de precio entre la fecha de renovación actual y la nueva fecha de renovación.';
...
$lang['AdminClients.makepayment.record_invoice'] = 'Registrar el pago de la nota de cobro #%1$s, en lugar de';
$lang['AdminClients.makepayment.record_payment'] = 'Registrar pago en su lugar';
$lang['AdminClients.makepaymentamount.heading_invoices'] = 'Selección de notas de cobro';
...
$lang['AdminClients.makepaymentamount.text_invoice'] = 'Nota de cobro #';
$lang['AdminClients.makepaymentamount.text_datedue'] = 'Fecha de vencimiento';
$lang['AdminClients.makepaymentamount.no_results'] = 'No hay notas de cobro en esta moneda.';
...
$lang['AdminClients.makepaymentconfirm.text_invoice'] = 'Nota de cobro #';
...
$lang['AdminClients.services.action.invoice_renewal'] = 'Renovación de notas de cobro';
...
$lang['AdminClients.transactions.headingexpand_invoice'] = 'Nota de cobro';
...
$lang['AdminClients.transactions.applied_no_results'] = 'Esta transacción no se ha aplicado a ninguna nota de cobro.';
...
$lang['AdminClients.view.setting_invoicemethod'] = 'Método de notas de cobro';
...
$lang['AdminClients.view.actionlink_createinvoice'] = 'Crear nota de cobro';
...
$lang['AdminClients.!success.invoice_split'] = 'La nota de cobro #%1$s se ha dividido correctamente en la nota de cobro #%2$s.';
...
$lang['AdminClients.editinvoice.field_invoicesplit'] = 'Nota de cobro dividida';
$lang['AdminClients.editinvoice.confirm_split'] = '¿Está seguro de dividir la nota de cobro?';
...
$lang['AdminClients.invoices.merge_placeholder'] = 'Nota de cobro de destino (opcional)';
...
$lang['AdminClients.!success.invoices_merged'] = 'Las notas de cobro seleccionadas se han fusionado correctamente.';
$lang['AdminClients.invoices.action_merge'] = 'Fusionar notas de cobro';
...
$lang['AdminClients.editservice.field_invoice_method_dont'] = 'No cobrar';
$lang['AdminClients.editservice.field_invoice_method_append'] = 'Añadir a la nota de cobro';
$lang['AdminClients.editservice.field_invoice_method_create'] = 'Crear nota de cobro';
$lang['AdminClients.editservice.field_invoice_method'] = 'Método de notas de cobro';
