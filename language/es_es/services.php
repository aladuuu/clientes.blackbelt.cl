...
$lang['Services.!error.move.unpaid_invoices'] = 'El servicio no puede trasladarse a otro cliente, porque tiene notas de cobro impagadas.';
...
$lang['Services.!error.id_format.empty'] = 'No se ha establecido ningún formato de identificación para las notas de cobro.';
$lang['Services.!error.id_format.length'] = 'El formato de identificación de las notas de cobro no puede superar los 64 caracteres.';
$lang['Services.!error.id_value.valid'] = 'No se puede determinar el valor del ID de la nota de cobro.';
...
$lang['Services.!error.invoice_method.valid'] = 'Debe seleccionar un método de notas de cobro válido.';
