...
$lang['ClientMain.!success.invoice_method_updated'] = 'Su método de notas de cobro se ha actualizado correctamente. Todas las notas de cobro futuras se le enviarán a través de %1$s.';
...
$lang['ClientMain.!tooltip.invoice_method_email'] = 'Las notas de cobro se enviarán por correo electrónico a la dirección que tenemos registrada.';
$lang['ClientMain.!tooltip.invoice_method_paper'] = 'Imprimiremos y enviaremos las notas de cobro a la dirección que tenemos registrada.';
$lang['ClientMain.!tooltip.invoice_method_interfax'] = 'Le enviaremos automáticamente las notas de cobro por fax al número de fax que tenemos registrado. Si selecciona esta opción, asegúrese de que disponemos de un número de fax válido.';
$lang['ClientMain.!tooltip.invoice_method_postalmethods'] = 'Imprimiremos y enviaremos automáticamente las notas de cobro a la dirección que tenemos registrada.';
...
$lang['ClientMain.myinfo.setting_invoices'] = 'Actualmente está recibiendo notas de cobro por %1$s.';
...
$lang['ClientMain.edit.heading_billing'] = 'Información de notas de cobro';
$lang['ClientMain.edit.field_taxid'] = 'Número de identificación RUT';
$lang['ClientMain.edit.field_default_currency'] = 'Moneda preferente';
$lang['ClientMain.edit.field_invoiceaddress'] = 'Dirección de notas de cobro';
...
$lang['ClientMain.invoicemethod.page_title'] = 'Cliente #%1$s Método de notas de cobro';
$lang['ClientMain.invoicemethod.boxtitle_inv_method'] = 'Método de notas de cobro';
$lang['ClientMain.invoicemethod.text_invoice_method'] = 'Su método de notas de cobro es el método por el que le entregamos las nuevas notas de cobro.';
